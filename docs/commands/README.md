...
docker build -t rogeriofontes/selectgearmotors-client-api:v3 .
docker login
docker push rogeriofontes/selectgearmotors-client-api:v3

docker pull rogeriofontes/selectgearmotors-client-api:v3
docker run -p 9914:9914 -e  rogeriofontes/selectgearmotors-client-api:v3
docker run -p 9914:9914 --env-file .env rogeriofontes/selectgearmotors-client-api:v3
docker run -p 9914:9914 --env-file .env -e SPRING_PROFILES_ACTIVE=dev rogeriofontes/selectgearmotors-client-api:v3
====
